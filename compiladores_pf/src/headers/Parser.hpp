...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_BREAK_MARK: // BREAK_MARK
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_FLOAT_LITERAL (const float& v)
      {
      ...
      static
      symbol_type
      make_CHAR_LITERAL (char v)
      {
        return symbol_type (token::CHAR_LITERAL, std::move (v));
      }
#else
      static
      symbol_type
      make_CHAR_LITERAL (const char& v)
      {
        return symbol_type (token::CHAR_LITERAL, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
